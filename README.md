...
**향로**는 기도를 올리면 기도 이모지가 향로에서 바깥으로 터져 나갑니다.

**램프**는 주둥이에서 연기가 오르고, 기도를 올리면 손이 배를 문지릅니다. 그다음
소원이 통하면 황금 연기가 지그재그로 흘러나오고, 헛것이었으면 검은 연기를 기침하듯
뱉습니다. 어느 쪽인지는 설정이 아니라 **확률**입니다.
